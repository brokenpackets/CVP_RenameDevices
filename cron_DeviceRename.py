...
builder_name = 'builder_rename.py'
...
def get_items_in_undefined(url_prefix):
    ...
    for device in device_list:
        ...
        if deviceHostname.startswith('sw-'):
            if device['ztpMode'] == True and device['parentContainerKey'] == 'undefined_container' and device['streamingStatus'] == 'active':
